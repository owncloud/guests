...
class Application extends App {
	...
	public function __construct() {
		...
		$server->getEventDispatcher()->addListener(UserExtendedAttributesEvent::USER_EXTENDED_ATTRIBUTES,
	...
	private function addUserAppAttributes(IServerContainer $server, UserExtendedAttributesEvent $attributesEvent, $userAppAttributes) {
		...
		if ($isGuestUser !== '0') {
			...
			/**
			 * Add whitelistedAppsForGuests attribute if its not present. There is a
